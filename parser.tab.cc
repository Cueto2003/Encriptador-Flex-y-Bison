...
#line 1 "Bison.y"
    ...
    //Para manejar es stack 
    extern void push_buffer_for_file(FILE *f);
    extern void pop_buffer_back(); 
...
#line 65 "Bison.y"
    {
        FILE *f = fopen((yystack_[0].value.filename), "r");
        if (!f) {
            perror((yystack_[0].value.filename));
        } else {
...
#line 607 "parser.tab.cc"
  ...
  parser::yyrline_[] =
  {
       0,    51,    51,    54,    58,    59,    65,    63,    75,    79,
      83,    84,    88,    89,    90,    91,    95,    96,   100,   101,
     102,   103,   107,   108,   113,   114,   115,   116,   117
  };
